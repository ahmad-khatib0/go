...
// testInitExisting(*testing.T, *log.Log) tests that when we create a log, the log bootstraps itself from the
// data stored by prior log instances. We append three records to the original log before closing it. Then we
