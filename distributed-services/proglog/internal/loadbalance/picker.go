...
// Pick(balancer.PickInfo). gRPC gives Pick() a balancer.PickInfo containing
//
// the RPC’s name and context to help the picker know what subconnection to pick.
...
// nextFollower() balance the consume calls across the followers with the round-robin algorithm.
