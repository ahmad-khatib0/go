...
func TestProviderIndex_Local(t *testing.T) {
	...
	// Initialise
	pact := dsl.Pact{Provider: "BookSwap"}
...
func getTestEndpoint(t *testing.T) string {
	// Helper marks the calling function as a test helper function. When printing file and line information,
	// that function will be skipped. Helper may be called simultaneously from multiple goroutines.
	t.Helper()
