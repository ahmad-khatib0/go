...
//  3. The input parameters for the function must be comparable.
func Memoizer(f interface{}, expiration time.Duration) (interface{}, error) {
	ft := reflect.TypeOf(f)
...
func main() {
	...
	// you need to use a type assertion to get back the function from the returned interface{}
